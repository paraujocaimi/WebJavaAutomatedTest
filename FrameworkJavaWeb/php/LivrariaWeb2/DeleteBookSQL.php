...
<html>
    ...
    <body>
        ...
        if (!$searchtype || !$searchterm){
            echo "Você não entrou com argumentos de pesquisa, favor voltar para a pagina anterior.";
            exit;
        }
		
        if ($searchtype != 'idlivros'){
			//echo "<br>teste2<br>";
        ...
        $servidor = 'localhost';
            ...
            $SQL = "SELECT * FROM livraria.livros where ".$searchtype." = ".$searchterm.";";
			//echo "<br>".$SQL."<br>";
            $SQL2 = "DELETE FROM livraria.livros where ".$searchtype." = ".$searchterm.";";
			//echo "<br>".$SQL2."<br>";
            $RS  = mysqli_query($link,$SQL);
            if (mysqli_num_rows($RS) == 0) { 
                  echo "Nenhum livro encontrado!";//results are empty, do something here
                  exit;
                }
            else{
                echo '<h3>Cadastros excluidos</h3>';
